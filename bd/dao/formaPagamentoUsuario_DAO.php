    ...
    function inserirForma(Formapagamento $formapagamento)
    {
        try {
            ...
            $resultado = $query->execute([
                'user_id' => $formapagamento->getUserId(),
                'nome_titular' => $formapagamento->getNomeTitular(),
                'nome_cartao' => $formapagamento->getNomeCartao(),
                'numero_cartao' => $formapagamento->getNumeroCartao(),
